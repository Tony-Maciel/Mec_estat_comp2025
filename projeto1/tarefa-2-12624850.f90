...
real(dp), parameter :: dt = 4e-1_dp   ! time interval 
integer, parameter  :: N = 200       ! number of time intervals
real(dp), parameter :: a1 = 3.0_dp, a2 = 2.0_dp, w1 = 4.0_dp * pi, w2 = 0.2_dp * pi ! w = 2pif
...
open(newunit=io1,file="entrada-2-4-12624850.in",action="write")
    write(io1,*) N, dt
    do i = 1, N 
...
open(newunit=io2,file="entrada-2-4-12624850.in",action="read")
...
open(newunit=io3,file="saida-2-4-12624850.out",action="write")
    do i = 1, read_N 
